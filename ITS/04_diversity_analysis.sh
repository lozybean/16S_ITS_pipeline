...
echo \
"align_seqs.py -i $rep_set -m $align_seq_method -o $alpha_sub_dir/$align_seq_method\_alignment
make_phylogeny.py -i $alpha_sub_dir/$align_seq_method\_alignment/rep_set_aligned_pfiltered.fasta -o $alpha_sub_dir/rep_phylo.tre" >$sub_dir/work.sh
