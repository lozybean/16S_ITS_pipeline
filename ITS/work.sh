...
work_dir=
group_num=
fna_file=$work_dir/ITS_together.fna
group_file=$work_dir/group.txt

#{{{
# importing pipeline default settings ...
pipeline_path=/data_center_01/home/NEOLINE/liangzebin/pipeline/16S/pipeline_ver_1.0/ITS
source $pipeline_path/ITS_all_config.sh
