...
pick_rep_set.py -i $otu_downsize -f $seq_downsize -o $sub_dir/rep_set.fna -l $sub_dir/pick_rep_set_log -m $pick_rep_method
assign_taxonomy.py -i $sub_dir/rep_set.fna -m $ass_tax_method -r $gg_ref -t $gg_tax -o $ass_tax_outdir
