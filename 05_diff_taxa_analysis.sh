...
$script_05_tax_diff -profile $all_level_outdir/otu_table_all.trans.txt -group $group_file -gnum $group_num -qcutoff $p_cutoff -pair $if_paired
...
$script_05_tax_diff -profile $genus_level_outdir/otu_table_L6.txt -group $group_file -gnum $group_num -qcutoff $p_cutoff -pair $if_paired
...
$script_05_tax_diff -profile $otu_diff_outdir/otu_table_otu.txt -group $group_file -gnum $group_num -qcutoff $p_cutoff -pair $if_paired
